...
import { Plus, ArrowDownLeft, ArrowUpRight, ChevronRight, IndianRupee } from "lucide-react";
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-orange-600">{periodLabels[withdrawalPeriod]}</p>
                </div>
